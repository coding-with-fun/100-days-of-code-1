...
Made with :heart: and :coffee: by [Harsh Patel](https://github.com/harsh2124)
...
2. Fork the repo and commit to the [Log](log.md) or to the Alternative, rapid [R1 Log](r1-log.md) (R1 stands for Round 1) daily. [Example](https://github.com/Kallaway/100-days-kallaway-log).
...
* If you have any questions or ideas about 100DaysOfCode (or other ideas), feel free to reach out to me on Twitter: [@dev_harsh2124](https://twitter.com/dev_harsh2124)
